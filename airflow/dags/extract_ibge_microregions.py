...
IBGE_ENDPOINT = "https://servicodados.ibge.gov.br/api/v1/localidades/microrregioes"
FILENAME = "ibge_microregions_export"
...
def extract_and_load():
    ...
    s3_client.upload_fileobj(
        obj,
        LANDING_ZONE,
        f"ibge/microregions/extract_date={now.strftime(DATE_FORMAT_STR)}/{filename}"
    )
...
def ibge_microregions_ingestion():
...
dag = ibge_microregions_ingestion()
